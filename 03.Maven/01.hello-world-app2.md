...
class HelloController {
    ...
    @PostMapping("/submit")
    public Map<String, Object> submit(@RequestBody User user) {
...
class AppTest {
    ...
    void helloEndpointShouldReturnJson() {
        ...
        assertThat(response.getBody().get("message")).isEqualTo("Hello, World from Spring Boot!");
    }
    ...
    void greetEndpointShouldReturnJson() {
        ...
        assertThat(response.getBody()).containsKeys("message", "timestamp");
        assertThat(response.getBody().get("message")).isEqualTo("Hello, Ganapathi!");
    }
    ...
    void submitEndpointShouldReturnJson() {
        ...
        assertThat(response.getBody()).containsKeys("name", "email", "status", "timestamp");
        assertThat(response.getBody().get("name")).isEqualTo("Ganapathi");
        assertThat(response.getBody().get("status")).isEqualTo("Received successfully");
    }
    ...
    void statusEndpointShouldReturnJson() {
        ...
        assertThat(response.getBody().get("status")).isEqualTo("Application is running fine!");
    }
}
```
---
