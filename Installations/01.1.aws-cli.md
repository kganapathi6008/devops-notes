...
If you have [Chocolatey](https://chocolatey.org/) installed, you can install AWS CLI with a single command in an elevated PowerShell:

```powershell
choco install awscli -y
```

This will automatically download and install the latest AWS CLI version for Windows.
